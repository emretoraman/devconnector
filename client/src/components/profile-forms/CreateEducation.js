...
const CreateEducation = ({ createEducation, history }) => {
    ...
    return (
        <Fragment>
            ...
            <form className="form" onSubmit={onSubmit}>
                ...
                <div className="form-group">
                    <input type="text" placeholder="* Field of Study" name="fieldofstudy" required value={fieldofstudy} onChange={onChange} />
                </div>
                <div className="form-group">
                    <h4>From Date</h4>
                ...
                <div className="form-group">
                    <p><input type="checkbox" id="current" name="current" checked={current} onChange={onChange} /> <label htmlFor="current">Current School or Bootcamp</label></p>
                </div>
                <div className="form-group">
                    <h4>To Date</h4>
...
export default connect(null, { createEducation })(withRouter(CreateEducation));
