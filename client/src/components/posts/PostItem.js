...
import { createLike, deleteLike, deletePost } from '../../actions/post';
    ...
    return (
        <div className="post bg-white p-1 my-1">
            ...
            <div>
                ...
                {showActions && (
                    <Fragment>
                        <button type="button" className="btn btn-light" onClick={() => createLike(_id)}>
...
export default connect(mapStateToProps, { createLike, deleteLike, deletePost })(PostItem);
